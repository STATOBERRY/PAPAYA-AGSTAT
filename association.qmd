...
Correlation is a statistical method used to analyze the relationship between two or more variables. The correlation measures the degree and
...
[Linear Correlation]{.underline}: A type of correlation where the relationship between two variables can be represented by a straight line. In this case, the change in one variable corresponds to a proportional change in the other, either positively or negatively.  

[Non-linear Correlation]{.underline}: A type of correlation where the relationship between two variables cannot be represented by a straight line. Instead, the relationship follows a curved pattern, indicating that the variables do not change at a constant rate relative to each other.  
