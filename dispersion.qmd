...
: Model frequency distribution table for range calculation {#tbl-rangemodel}  
...
: Calculation of mean absolute deviation {#tbl-mad1}
...
: Calculation of standard deviation set A {#tbl-stdsetA}  
...
: Calculation of standard deviation set B {#tbl-stdsetB} 
...
: Model dataset for standard deviation calculation {#tbl-alternatesd}
...
: Calculation of sd using alternate formula {#tbl-alternatesd2}
...
: A model frequency distributions of seed yield {#tbl-seedyld}
...
: Calculation of standard deviation for frequency table {#tbl-seedyld}
...
: A model gropued frequency distributions of seed yield {#tbl-grpseedyld}
...
: Calculation of sd for grouped frequency distribution {#tbl-grpfreqsd}
