...
: Model dataset to demonstrate dispersion {#tbl-dsp1}
...
**Example 6.3** Consider the two sets of data below, find IQR
...
$${\mathbf{\text{sample variance}},\ \mathbf{s}}^{\mathbf{2}}\mathbf{=}\frac{\sum_{\mathbf{i = 1}}^{\mathbf{n}}\left( \mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}} \right)^{\mathbf{2}}}{\mathbf{n - 1}}$$ {#eq-samplevariance}

The sample **standard deviation**, *s*, is the positive square root of the sample variance.

$$\mathbf{standard\ deviation = \ }\sqrt{\frac{\sum_{\mathbf{i = 1}}^{\mathbf{n}}\left( \mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}} \right)^{\mathbf{2}}}{\mathbf{n - 1}}}$$
...
**Example 6.4** Consider the @tbl-dsp1 discussed earlier, find the standard deviation?

**Solution** **6.4**

|  |  |  |  |
|:----------------:|:----------------:|:----------------:|:----------------:|
| Set A | $$\mathbf{x}_{\mathbf{i}}$$ | $$\left(\mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}}\right)$$ | $$\left(\mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}}\right)^{\mathbf{2}}$$ |
|  | 1 | -2 | 4 |
|  | 2 | -1 | 1 |
|  | 3 | 0 | 0 |
|  | 3 | 0 | 0 |
...
|  |  |  |  |
|:----------------:|:----------------:|:----------------:|:----------------:|
| Set B | $$\mathbf{x}_{\mathbf{i}}$$ | $$\left( \mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}} \right)$$ | $$\left( \mathbf{x}_{\mathbf{i}}\mathbf{-}\overline{\mathbf{x}} \right)^{\mathbf{2}}$$ |
|  | -1 | -4 | 16 |
|  | 0 | -3 | 9 |
|  | 3 | 0 | 0 |
|  | 3 | 0 | 0 |
...
**Example 6.5** Consider the data set below; find standard deviation?
...
**Example 6.6** The frequency distributions of seed yield of 50 sesamum plants are given below. Find the standard deviation.
...
| **Seed yield** |  *f*   |  *x*   | $$d_{i} = \frac{x_{i} - A}{c}$$ |  *f.d*  | *f.d^2^* |
|:---------:|:---------:|:---------:|:------------------:|:---------:|:---------:|
|    2.5-3.5     |   4    |   3    |               -2                |   -8   |    16    |
|    3.5-4.5     |   6    |   4    |               -1                |   -6   |    6     |
|    4.5-5.5     |   15   |   5    |                0                |   0    |    0     |
...
$$\mathbf{\text{Coefficient of variation}}\left( \mathbf{C}\mathbf{.}\mathbf{V} \right)\mathbf{=}\frac{\mathbf{\text{standard deviation}}}{\mathbf{\text{mean}}}\mathbf{\times 100}$$ {#eq-cv}
...
**Example 6.8** Consider the measurement on yield and plant height of a paddy variety. The mean and standard deviation for yield are 50 kg and 10 kg respectively. The mean and standard deviation for plant height are 55 cm and 5 cm respectively. Compare the variability.
