...
**Grouped bar chart**  
@fig-cbsales can also be represented using a grouped bar chart shown in @fig-groupedbar. For a grouped bar chart, each category within a group is represented by a bar with a distinct shade or color, allowing for clear comparisons both within and across groups.  
