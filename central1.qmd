...
: Plant height of 50 plants {#tbl-plantheight .bordered .hover}
...
: Solution using direct method {#tbl-pltheightsolutn .bordered .hover}
...
: Solution using assumed mean method {#tbl-pltheightassumed .bordered .hover}
...
: Distribution of the marks scored by 60 students {#tbl-math .bordered .hover}
...
: Mean of grouped frequency table using direct method {#tbl-pltheightsolutn .bordered .hover}
...
: Solution using coding method {#tbl-pltheightcoding .bordered .hover}
...
**Example 4.5**: The @tbl-score shows the frequency of the score obtained in a mathematics quiz. Find the median score.
...
: Score obtained in a mathematics quiz {#tbl-score .bordered .hover}
...
**Example 4.6**: The @tbl-median is a frequency table of the marks obtained in a competition. Find the median score.
...
**Example 4.7** @tbl-medianheight below gives the distribution of the heights of 60 students in a senior high school. Find the median height of the students
...
: Distribution of heights of 60 students {#tbl-medianheight .bordered .hover}
...
**Example 4.9** 20 patients selected at random had their blood groups determined. The results are given in the @tbl-letters
...
: Blood group of 20 patients {#tbl-letters .bordered .hover}
...
**Example 4.10** For the frequency distribution of weights of sorghum ear-heads given in @tbl-earhead below. Calculate the mode.
...
: frequency distribution of weights of sorghum ear heads {#tbl-earhead .bordered .hover}
