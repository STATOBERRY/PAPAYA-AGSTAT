...
: log values of sorghum ear head weights {#tbl-sorghumear .bordered .hover}
...
: Frequency distribution and log for GM calculation {#tbl-gmfreq .bordered .hover}
...
: Geometric mean calculation for grouped frequency table {#tbl-gmgrpfreq .bordered .hover}
...
: Inverse of numbers to calculate harmonic mean {#tbl-hmcalc .bordered .hover}
...
: Model data for harmonic mean calculation {#tbl-tomato .bordered .hover}
...
: Calculation of harmonic mean from frequency table {#tbl-freqhm .bordered .hover}
...
: A model frequency distribution {#tbl-quartile .bordered .hover}
...
: Cumulative frequency data for quartile calculation {#tbl-qtlcalc .bordered .hover}
...
: A model grouped frequency data {#tbl-grpdqrtl .bordered .hover}
...
$\mathbf{P}_{\mathbf{p}}\mathbf{=}\left( \frac{\mathbf{p}\left( \mathbf{n + 1} \right)}{\mathbf{100}} \right)^{\mathbf{\text{th}}}$ item
...
$$\mathbf{D}_{\mathbf{d}}\mathbf{= l +}\frac{\left( \frac{\mathbf{d \times n}}{\mathbf{10}} \right)\mathbf{- cf}}{\mathbf{f}}\mathbf{\times c}$$ {#eq-decile}
...
Find $\text{D}_{5}$ for Example 5.9, 5.10 & 5.11; verify that $\text{D}_{5} = \text{Q}_{2} = \text{P}_{50} = median$
:::
