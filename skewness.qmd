...
1.  **Skewness**, which quantifies the degree of asymmetry in the data distribution.
2.  **Kurtosis**, which measures the "tailedness" or peakedness of the distribution.
...
![symmetric distribution](images/image3_5.jpeg){#fig-symmdist fig-align="center" width="70%" style="text-align:center;"}

@fig-histodata shows a model data set with skewness = 0 (symmetric distribution) 

![Data set with skewness = 0](images/image4_5.jpeg){#fig-histodata fig-align="center" width="70%" style="text-align:center;"}
...
![Left skewed or negatively skewed distribution](images/image5_5.jpeg){#fig-leftskew fig-align="center" width="70%" style="text-align:center;"}

@fig-negskewed shows a model dataset with negative skewness.

![Negatively skewed data set](images/image6_5.jpeg){#fig-negskewed fig-align="center" width="70%" style="text-align:center;"}
...
![Right skewed or positively skewed distribution](images/image7_5.jpeg){#fig-posskewed fig-align="center" width="70%" style="text-align:center;"}

@fig-rightskeweddat shows a model dataset with positive skewness.

![Data set with positive skewness or right skewed](images/image8_5.jpeg){#fig-rightskeweddat fig-align="center" width="70%" style="text-align:center;"}
...
: Model dataset for skewness calculation {#tbl-skewnessmodel}
...
: Cumulative frequency for skewness calculation {#tbl-karlcf}
...
**Try yourself** Try to find Kelly's Measure of Skewness for @tbl-skewnessmodel
:::
...
![Three categories of frequency curves](images/image10_5.jpeg){#fig-kurtopeak fig-align="center" width="70%" style="text-align:center;"}
...
dt %>%
  kbl(booktabs = FALSE, align = "c", escape = FALSE, format = "html") %>%
  kable_classic(full_width = FALSE, html_font = "Georgia") %>%
  kable_styling(
    # latex_options = "HOLD_position", 
    full_width = FALSE,
...
![Frequency curve of Example 7.1](images/image11_5.jpeg){#fig-freqcurvex fig-align="center" width="70%" style="text-align:center;"}  
